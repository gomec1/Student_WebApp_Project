...
![Landingpage Two4Four](docs/Landingpage_Two4Four.png)
_Landingpage Two4Four_
...
![Voreingestellter Typ "User" in Strapi](docs/User_Typ_Strapi.png)

_Voreingestellter Type "User" von Strapi_
